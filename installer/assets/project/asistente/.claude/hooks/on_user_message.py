...
NOTIFY_FILE      = Path.home() / ".adaptive_cli" / "last_learning.txt"
CLASSIFY_CACHE   = Path.home() / ".adaptive_cli" / "classify_cache.json"
CO_OCCUR_FILE    = Path.home() / ".adaptive_cli" / "domain_cooccurrence.json"
MARKOV_FILE      = Path.home() / ".adaptive_cli" / "domain_markov.json"
PROMPT_HIST_FILE = Path.home() / ".adaptive_cli" / "prompt_history.jsonl"
INJECTION_FILE   = Path.home() / ".adaptive_cli" / "last_injection.json"
MSG_TYPE_FILE    = Path.home() / ".adaptive_cli" / "hook_state" / "msg_type.json"
...
def classify_domains(keywords: list) -> list:
    ...
    try:
        ...
        hints_file = Path.home() / ".adaptive_cli" / "knowledge" / "domain_hints.json"
        learned_hints = {}
